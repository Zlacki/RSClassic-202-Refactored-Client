...
public class BZip2Decompressor {
	...
	public static int decompressBuffer(byte outputBuffer[],
			...
			int offset) {
		synchronized (CURRENT_BLOCK) {
			CURRENT_BLOCK.inputBuffer = inputBuffer;
			CURRENT_BLOCK.offset = offset;
			CURRENT_BLOCK.outputBuffer = outputBuffer;
			CURRENT_BLOCK.anInt569 = 0;
			CURRENT_BLOCK.compressedSize = compressedSize;
			CURRENT_BLOCK.decompressedSize = decompressedSize;
			CURRENT_BLOCK.anInt577 = 0;
			CURRENT_BLOCK.anInt576 = 0;
			CURRENT_BLOCK.anInt566 = 0;
			CURRENT_BLOCK.anInt567 = 0;
			CURRENT_BLOCK.anInt571 = 0;
			CURRENT_BLOCK.anInt572 = 0;
			CURRENT_BLOCK.anInt579 = 0;
			readBlock(CURRENT_BLOCK);
			decompressedSize -= CURRENT_BLOCK.decompressedSize;
	...
	private static final BZip2BlockEntry CURRENT_BLOCK = new BZip2BlockEntry();
